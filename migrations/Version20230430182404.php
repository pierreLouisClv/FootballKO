 ...
 */
final class Version20230430182404 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE club CHANGE last_injury_update last_injury_update DATETIME NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE club CHANGE last_injury_update last_injury_update DATE DEFAULT NULL');
    }
}
