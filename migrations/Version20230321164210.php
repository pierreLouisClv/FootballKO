 ...
 */
final class Version20230321164210 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article ADD mentionned_club_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE article ADD CONSTRAINT FK_23A0E66EF28E107 FOREIGN KEY (mentionned_club_id) REFERENCES club (id)');
        $this->addSql('CREATE INDEX IDX_23A0E66EF28E107 ON article (mentionned_club_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article DROP FOREIGN KEY FK_23A0E66EF28E107');
        $this->addSql('DROP INDEX IDX_23A0E66EF28E107 ON article');
        $this->addSql('ALTER TABLE article DROP mentionned_club_id');
    }
}
