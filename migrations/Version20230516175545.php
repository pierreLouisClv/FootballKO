 ...
 */
final class Version20230516175545 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE player ADD external_info_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE player ADD CONSTRAINT FK_98197A65842918BB FOREIGN KEY (external_info_id) REFERENCES external_article (id)');
        $this->addSql('CREATE INDEX IDX_98197A65842918BB ON player (external_info_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE player DROP FOREIGN KEY FK_98197A65842918BB');
        $this->addSql('DROP INDEX IDX_98197A65842918BB ON player');
        $this->addSql('ALTER TABLE player DROP external_info_id');
    }
}
