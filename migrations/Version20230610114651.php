 ...
 */
final class Version20230610114651 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE championship ADD season INT DEFAULT NULL, ADD is_active TINYINT(1) NOT NULL');
        $this->addSql('ALTER TABLE injury_article ADD season INT DEFAULT NULL');
        $this->addSql('ALTER TABLE injury_tab ADD season INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE championship DROP season, DROP is_active');
        $this->addSql('ALTER TABLE injury_article DROP season');
        $this->addSql('ALTER TABLE injury_tab DROP season');
    }
}
