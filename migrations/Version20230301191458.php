 ...
 */
final class Version20230301191458 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE championship ADD slug VARCHAR(128) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE championship DROP slug');
    }
}
